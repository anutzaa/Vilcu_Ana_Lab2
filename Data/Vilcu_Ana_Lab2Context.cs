...
namespace Vilcu_Ana_Lab2.Data
{
    public class Vilcu_Ana_Lab2Context : DbContext
    {
        ...
        public DbSet<Vilcu_Ana_Lab2.Models.Category>? Category { get; set; }

        public DbSet<Vilcu_Ana_Lab2.Models.Member>? Member { get; set; }

        public DbSet<Vilcu_Ana_Lab2.Models.Borrowing>? Borrowing { get; set; }
    }
}
